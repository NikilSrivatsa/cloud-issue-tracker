...
- Login page with demo accounts and session-based access
- Role behavior: admin/devops can modify tickets, viewer is read-only
- Edit ticket page with investigation comments
- Audit trail for create, edit, status, comment, and delete actions
- JSON export endpoint at `/api/issues`
...
| --- | --- | --- |
| `admin` | `admin123` | Cloud Admin |
| `devops` | `devops123` | Pipeline Owner |
